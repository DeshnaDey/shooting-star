// Rainbow "nebula" background. Two looks:
//   - "horizontal" (default): a wide band that drifts sideways (tradecenter, profile)
//   - "spiral": a slowly-rotating spiral galaxy (arcade)
...
export default function NebulaDrift({ variant = "horizontal" }: { variant?: "horizontal" | "spiral" }) {
  if (variant === "spiral") {
    return (
      <div className="nebula-drift spiral" aria-hidden>
